...
namespace Into_The_Void_Character_Gen
{
    class Careers
    {
        ...
        {            
            ...
            CareerList.Add(new List<string> { "Uncoordinated", "You lose one level in Dexterity (dex cannot be reduced below level 1). You may select an additional ability from any category or raise an additional attribute by one level." });
            CareerList.Add(new List<string> { "Quick Draw", "You are quite skilled with a variety of Small Arms but very nervous around alien wildlife. You gain an additional Degree of Success for any Small Arms based action however, you must fire upon any animals you encounter and accept any consequences that result from your wanton weapon usage." });
